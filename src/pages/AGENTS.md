...
| Route | File | Purpose |
|-------|------|---------|
| `/` | [[src/pages/index.astro|index.astro]] | Homepage (minimal blog list over backdrop) |
| `/blog/` | [[src/pages/blog/index.astro|blog/index.astro]] | Full blog archive (filters + thumbnails) |
